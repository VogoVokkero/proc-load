...
const char *gengetopt_args_info_purpose = "CPU global and per process.";

const char *gengetopt_args_info_usage = "Usage: proc-load [OPTION]...";
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'c':	/* path to the json file, that specifies process to monitor..  */
